...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  uint8_t message[64];
  int len; //to store the number of characters in a string
  /* USER CODE END 2 */
  ...
  while (1)
  {
	...
	if (can_received_flag){
        ...
        len = sprintf((char*)message,
					  "RX ID: %1lu | Data: %02X %02X %02X %02X\r\n",
					  rxheader.Identifier,
